...
?>
  ...
  <body data-responsejs='{ "create": [ { "prop": "width", "breakpoints": [0, 320, 481, 641, 961, 1025, 1281, 1400] }]}'>
          ...
          <div class="container">
              <div class="col-lg-12">
                  ...
                  <form method="post" action="search.php">
                      <h4 class="pull-right pagination">&nbsp Donate</h4>
      ...
      <div class="inner-page services">
          <div class="container">
              <h2>Project:  <?php echo $row2["title"] ?></h2>
              <br />
              <table>
                  <form method="post" action="submitDonation.php">
                      <tr>
                          <td class="auto-style1">Currency: </td>
                          <td class="auto-style1">
                              <input type="hidden" value="<?php echo $projectID ?>" name="projectID" />&nbsp; &nbsp;</td>
                          <td class="auto-style1">
                      ...
                      <tr>
                          ...
                          <td class="auto-style1">
                              <input type="number" name="amount" step="any" value="0.00" />&nbsp;<input type="submit" value="Donate" /></td>
                      </tr>
                  </form>
              </table>
