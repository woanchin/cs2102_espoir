...
<body data-responsejs='{ "create": [ { "prop": "width", "breakpoints": [0, 320, 481, 641, 961, 1025, 1281, 1400] }]}'>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="createNewAdmin.php">Create New Admin Account<span class="sr-only">(current)</span></a></li>
    ...
    <div class="inner-head">
        <div class="container">
            <div class="col-lg-12">
                <h4 class="pull-left">New Administrator</h4>
            </div>
        </div>
    </div>
    <!-- inner-head end -->
    <div class="inner-page about-us">
        <div class="container">
            <div class="">                
                <div class="col-md-6">
                    <form name="signUpForm" id="signUpForm" action="signupA.php" method="post" enctype="multipart/form-data">
                        <div>
                        ...
                        <div>
                            <input type="submit" name="signUpBtn" id="signUpBtn" value="Create Now!">
                        </div>
                    </form>
                    <br />
                </div>
