...
$bio = $_POST["bio"];
	...
	$result= UploadFile("test", $allowed, 10000000);
				if ($result[0] == 0) {
					...
					// Query String
					$query = "INSERT INTO `user` (`userEmail`,`password`, `firstName`,  `lastName`,  `nationality`,`birthday`,`gender`,`picScr`,`picName`,`bio`) VALUES ('$userEmail','$userPassword','$firstName','$lastName','$nationality','$birthday','$gender', '{$imgData}', '$filename.jpg','$bio')";	
