            ...
            <div class="">
                <div class="col-md-6 no-padding-left">
                    ...
                    <form action="AdminManager.php" method="post">
                        <table>
                        <tr>
                            <td width="100px"><label for="emailtxt">Email:</label></td>
                            <td><input name="emailtxt" type="text" id="emailtxt" style="width:200px!important;height:25px; text-transform: lowercase;" required></td>
                        </tr>
                        <tr>
                            <td><label for="loginPassword">Password:</label></td>
                            <td><input type="password" name="loginPassword" id="loginPassword" style="width:200px!important;height:25px" required></td>
                        </tr>
                        <tr>
                            <td colspan="2" height="50px"><center><input type="submit" name="login" id="login" value="Login"></center></td>
                        </tr>
                        </table><br />
                ...
                <div class="col-md-6">
                    ...
                    <form name="signUpForm" id="signUpForm" action="signup.php" method="post" enctype="multipart/form-data">
                        ...
                        <br />
                        <div>
                            <label for="picSrc">Profile Picture : </label>
                            <input id="picSrc" name="test" type="file" accept="image/*" required />
                        </div>
                        <br />
                        <div>
                            <label>About Me : </label>
                            <textarea name="bio" cols="20" rows="2"></textarea>
                        </div>
                        <div>
