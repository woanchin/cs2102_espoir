...
<div class="inner-page services">
  <div class="container">
    <div class="">
      <div class="col-md-6 no-padding-left"> <img src="image/<?php echo $row2["picName"]; ?>"> 
        <!--<img src="image/">--> 
      </div>
      <div class="col-md-6">
        <h2><?php echo $row2["firstName"] ?>'s Profile</h2>
        <p> Name: <?php echo $row2["lastName"]." ".$row2["firstName"] ?> <br />
          <br/>
          Email: <?php echo $row2["userEmail"] ?> <br />
          <br/>
          Nationality: <?php echo $row2["nationality"] ?> <br />
          <br />
          Birthday: <?php echo $row2["birthday"] ?> <br />
          <br />
          Gender: <?php echo $row2["gender"] ?> <br />
          <br />
...
<div class="footer">
  <div class="container">
    ...
    <div class="col-md-4 testimonial">
      ...
      <div class="t-image"> <img src="img/testimonial.png">
        <h6>- Joyce He </h6>
        <br>
        <p>Team Lead</p>
      </div>
